...
```{r typePlot, fig.path='../manuscript/figs/', dev=c('png', 'pdf'), fig.width=9, fig.height=6}
...
ggsave(here::here("figures/mistake_type_plot.jpg"), mistake_type_plot, dpi = 300, height = 8, width = 12)
...
```{r causePlot, fig.path='../manuscript/figs/', dev=c('png', 'pdf'), fig.width=9, fig.height=6}
...
ggsave(here::here("figures/mistake_cause_plot.jpg"), mistake_cause_plot, dpi = 300, height = 8, width = 12)
...
ggsave(here::here("figures/mistake_cause_type_plot.jpg"), mistake_cause_type_plot, dpi = 300, height = 10, width = 15)
