...
The survey was sent out on _2023-05-09_ to the participants. Thus, any responses in the dataset before that date are coming from the testing of the survey. These responses will be excluded from further analysis. We excluded `r raw %>% dplyr::filter(lubridate::as_date(start_date) < lubridate::as_date("2023-05-09")) %>% nrow()` test responses. 
